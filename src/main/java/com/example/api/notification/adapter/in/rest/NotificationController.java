...
public class NotificationController {
    ...
    public FindNotificationDto createNotification(@Valid @RequestBody SaveNotificationDto saveNotificationDto) {
        SecurityUser securityUser = AuthenticationUtils.getCurrentUserAuthentication();
        if (securityUser == null) {
            log.error("NotificationController::createNotification: Login is needed");
    ...
    public UserNotificationDto createUserNotification(@Valid @RequestBody UserNotificationDto userNotificationDto) {
        SecurityUser securityUser = AuthenticationUtils.getCurrentUserAuthentication();
        if (securityUser == null) {
            log.error("NotificationController::createUserNotification: Login is needed");
            throw new CustomException(ErrorCodeEnum.LOGIN_IS_NOT_DONE);
        }
    ...
    public Optional<FindNotificationDto> getNotificationById(@PathVariable Long notificationId) {
        SecurityUser securityUser = AuthenticationUtils.getCurrentUserAuthentication();
        if (securityUser == null) {
            log.error("NotificationController::getNotificationById: Login is needed");
            throw new CustomException(ErrorCodeEnum.LOGIN_IS_NOT_DONE);
        }
    ...
    public void toggleReadState(@RequestBody UserNotificationDto userNotificationDto) {
        SecurityUser securityUser = AuthenticationUtils.getCurrentUserAuthentication();
        if (securityUser == null) {
            log.error("NotificationController::toggleReadState: Login is needed");
            throw new CustomException(ErrorCodeEnum.LOGIN_IS_NOT_DONE);
        }
